...
${OBJECTDIR}/Tree/Main.o: Tree/Main.c 
	...
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tree/Main.o Tree/Main.c

${OBJECTDIR}/Tree/Test.o: Tree/Test.c 
	${MKDIR} -p ${OBJECTDIR}/Tree
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tree/Test.o Tree/Test.c

${OBJECTDIR}/Tree/Tree_Structure/Stack.o: Tree/Tree_Structure/Stack.c 
	${MKDIR} -p ${OBJECTDIR}/Tree/Tree_Structure
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tree/Tree_Structure/Stack.o Tree/Tree_Structure/Stack.c

${OBJECTDIR}/Tree/Tree_Structure/Test_Tree.o: Tree/Tree_Structure/Test_Tree.c 
	${MKDIR} -p ${OBJECTDIR}/Tree/Tree_Structure
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tree/Tree_Structure/Test_Tree.o Tree/Tree_Structure/Test_Tree.c

${OBJECTDIR}/Tree/Tree_Structure/Tree.o: Tree/Tree_Structure/Tree.c 
	${MKDIR} -p ${OBJECTDIR}/Tree/Tree_Structure
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Tree/Tree_Structure/Tree.o Tree/Tree_Structure/Tree.c
